...
・「面接官の回答」について 
    ...
    ・採用倍率は5倍とする
    ・採用の判断基準は一般的な面接とおおよそ同じものとする
    ・面接してる職種は面接応募者から聞き出して「面接応募者の回答」に合った職種にすること
    ・一度決めた職種の変更や上書きは出来ない
    ・「面接応募者への面接官の印象」が 0 になるとシミュレーションアウトになる 
     ・シミュレーションアウト 　
        ・面接応募者が面接で不採用になった旨のメッセージを表示する
        ・その後は、どのような回答も受け付けない
    ・「面接応募者への面接官の印象」が 5 になるとシミュレーションクリアになる 
     ・シミュレーションクリア
        ・面接応募者が面接で採用になった旨のメッセージを表示する
        ・その後は、どのような回答も受け付けない
    ・「面接応募者への面接官の印象」を面接応募者に直接伝えてはなりません。
