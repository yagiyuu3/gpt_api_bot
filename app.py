...
・「ジョニー面接官の回答」について 
    ...
    ・「ジョニー面接官の回答」終了後、面接官は「総評」を行うこと
        ・「総評」では以下フォーマットで上から順番に必ず表示すること 
            ...
            ・「面接応募者の回答」への評価を「とても良い」「良い」「少し頑張ろう」「これからめっちゃ頑張ろう」の4段階のうち１つだけを表示し改行する
・「面接応募者の回答」について 
...
st.write("これは面接シミュレーションです。評価が**「とても良い」「良い」「少し頑張ろう」「これからめっちゃ頑張ろう」**の4段階で表示されます。")
st.write("練習に使ってみて下さい。")
